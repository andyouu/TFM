...
def obt_regressors(df,n) -> Tuple[pd.DataFrame, str]:
    ...
    new_df.loc[new_df['outcome_bool'] == 0, 'r_plus']  = 1/2
    new_df.loc[(new_df['outcome_bool'] == 1) & (new_df['choice'] == 'left'), 'r_plus'] = 0
    ...
    new_df.loc[new_df['outcome_bool'] == 1, 'r_minus']  = 1/2
    new_df.loc[(new_df['outcome_bool'] == 0) & (new_df['choice'] == 'left'), 'r_minus'] = 0
