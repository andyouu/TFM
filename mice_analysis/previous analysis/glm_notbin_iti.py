...
def significant_sessions(df, ) -> Tuple[pd.DataFrame, str]:
    """
    Summary:
    This function selects the significant sessions

    Args:
        df ([Dataframe]): [dataframe with experimental data]
        n ([int]): [threshold above which a session is considered significant]
